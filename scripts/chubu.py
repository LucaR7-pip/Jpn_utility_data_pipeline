# -*- coding: utf-8 -*-
"""
Chubu Electric Power Grid hourly demand parser.
"""
import io
import os
import zipfile
...
BASE_URL = "https://powergrid.chuden.co.jp/denki_yoho_content_data/download_csv/{year}{month:02d}_power_usage.zip"
